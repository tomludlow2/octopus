...
// Set up the URL
const url = `https://api.octopus.energy/v1/products/${product_code}/gas-tariffs/${gas_tariff_code}/standard-unit-rates/?period_from=${start_period}&period_to=${end_period}`;
