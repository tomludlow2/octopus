...
async function processChargingEvent(row_number) {
    ...
    try {
        ...
        // Determine the dateTime and price for notification
        const dateTime = start_time;
        const price = (sumResidualCost / 100).toFixed(2); // Convert pence to pounds
        ...
        if (!failInterval && !failCost) {
            ...
            return { dateTime, price }; // Return dateTime and price upon success
        } else {
            ...
            throw new Error('Event did not pass validation tests');
        }
